...
**Requirements:** Docker or Apple containers (macOS 26+ with Apple Silicon—auto-detected).
...
**Container runtimes**: Auto-detects Apple containers (macOS 26+, Apple Silicon) or Docker.
